...
if __name__ == "__main__":
    ...
    try:
        ...
        with connection:
            ...
            #     alice_qubit = AliceQubits(num_qubits=key_length_parts[i],
            ...
            def run_all_bs_thread( start_event: threading.Event, thread_id: int):
                print(f"Alice Thread {thread_id} - thread started")
                alice_qubit = AliceQubits(num_qubits=key_length_parts[thread_id],
                                    qubit_delay_us=qubit_freq_us,
                ...
                alice_qubits.append(alice_qubit)
                print(f"Alice Thread {thread_id} - qubits sent")
                ...
                alice_ccc = AliceThread(
                        ...
                        start_idx=0,
                        role=role_alice,
                        receive_queue=alice_queues[thread_id]
                )
                ...
                alice_cccs.append(alice_ccc)
                print(f"Alice Thread {thread_id} - thread finished")

...
# plt.grid(True)
# plt.show()
# plt.savefig("BB84/tests/bandwidth/images/payload_sizes_vs_bytes_per_frame.png")

GOLDEN_RATIO = (1 + 5 ** 0.5) / 2
plt.figure(figsize=(GOLDEN_RATIO * 6, 6))
# plt.plot(key_lengths, [bw * 10**-3 for bw in bandwidth], marker='o', label="Bandwidth Uplink")
plt.plot(key_lengths, [bw for bw in bandwidth_kbps], marker='o', label="Bandwidth Uplink")
...
plt.legend()
plt.tight_layout()
plt.savefig("BB84/tests/bandwidth/images/bandwidth_uplink_vs_key_length.png")
plt.show()

# Save data to file
with open("BB84/tests/bandwidth/data/bob_payload_sizes_vs_bytes_per_frame.csv", "w") as f:
...
with open("BB84/tests/bandwidth/data/bandwidth_uplink_vs_key_length.csv", "w") as f:

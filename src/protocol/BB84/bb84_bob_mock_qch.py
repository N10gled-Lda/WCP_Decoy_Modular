    ...
    while True:
        try:
            ...
            def run_all_bs_thread(start_event: threading.Event, thread_id: int):
                print(f"Bob thread {thread_id} - Starting...")
                bob_qubit = BobQubits(
                ...
                bob_qubit.run_mock_bob_qubits(connection, wait_time=True, fixed_fake_error_bool=True, fixed_fake_error_rate=0.1)

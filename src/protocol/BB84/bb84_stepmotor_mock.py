...
QUBIT_FREQ_US_DEFAULT = 1_000_000
# QUBIT_FREQ_US_DEFAULT = 1 / KEY_LENGTH_DEFAULT * 10**6
TEST_FRACTION = 0.1
NUM_THREADS_DEFAULT = 1

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Both's side of the BB84 protocol")
    ...
    parser.add_argument("-smc", "--step_motor_comport", type=str, default=None, help="Com Port for the step motor, e.g. COM5")
        ...
        with connection:
            ...
            def run_all_bs_thread( start_event: threading.Event, thread: int):
                ...
                alice_qubit = AliceQubits(num_qubits=key_length_parts[thread],
                                    ...
                                    loss_rate=loss_rate,
                                    com_port=step_motor_comport,
                    )
                if not step_motor_comport:

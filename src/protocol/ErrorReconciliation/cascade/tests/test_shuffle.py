...
def test_get_bit():
    ...
    #                             "10->1 11->2 12->8")
    assert shuffle.__str__() == "0->4 1->1 2->6 3->5 4->9 5->8 6->0 7->12 8->7 9->2 10->11 11->3 12->10"
    #assert shuffle.get_bit(key, 0) == 0   # Shuffle bit 0 -> Key bit 5 -> Bit value 1
    ...
    #assert shuffle.get_bit(key, 3) == 1
    #assert shuffle.get_bit(key, 4) == 0
    #assert shuffle.get_bit(key, 5) == 1
